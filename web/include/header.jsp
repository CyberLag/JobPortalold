...
<div class="header-top-bar">
    <div class="container">
        ...
        <div class="header-login">
            <a href="" class="btn btn-link">Admin Panel</a>
            <div>
        ...
        <nav>
            <ul class="primary-nav">
                ...
                <li class="has-submenu">
                    <a >Jobs</a>
                    <ul>
                        <li><a href="applied_offered_jobs.jsp?info=applied">Applied Jobs</a></li>
                        <li><a href="applied_offered_jobs.jsp?info=offered">Offered Jobs</a></li>
                    </ul>
                </li>
