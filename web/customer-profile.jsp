        ...
        <%
            ...
            //out.print(session.getAttribute("id"));
                ...
                if (request.getParameter("profile_id") != null) {
                    id = Integer.parseInt(request.getParameter("profile_id"));

                }
                String query1 = "select * from customer where customer_id=" + id;
                String query2 = "select skill_id from customer_skill where customer_id=" + id;
                //out.print(query2);
...
//out.print(query3);
                String url = "profile.jsp?customer_id=" + id;
                String img_dir = "img/" + id + ".jpg";
        ...
        <div id="main-wrapper">
            <header id="header" class="header-style-1">
                ...
                <div class="header-page-title">
                    <div class="container">
                        <h1><%=rs.getString("fullname")%><br><small><%if (rs.getInt("job_type") == 2) {%>Front-end Developer<%} else if (rs.getInt("job_type") == 3) {%>Back-end Developer<%}%></small></h1>
                    </div>
                </div>
            </header> <!-- end #header -->
        </header> <!-- end #header -->
                    ...
                    <div class="col-sm-8 page-content">
                        ...
                        <div class="candidates-item candidates-single-item">
                            ...
                            <ul class="list-unstyled">
                                ...
                                <li><strong>Working Hours:</strong> <%=rs.getInt("working_hours")%></li>
                                <li><strong>Experience:</strong> <%=rs.getInt("experience")%> Years</li>
                            </ul>
                            ...
                            <%while (rs2.next()) {
                                    ...
                                    ResultSet rs3;
                                    String query3 = "select skill_name from skill where skill_id=" + rs2.getInt("skill_id");
                                    //out.print(query3);
