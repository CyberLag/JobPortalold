    ...
    <body>
        ...
        <%
            ...
            try {
                ...
                String query1 = "update customer set customer_location='" + customer_location + "', customer_department='"
                        + customer_department + "', customer_degree='" + customer_degree + "', customer_university='" 
                        + customer_university + "', customer_university_location='" + customer_university_location 
                        + "', customer_details='" + customer_details + "',job_type=" + job_type + ",working_hours="+ working_hours+",experience="+experience+" where customer_id=" + customer_id;
