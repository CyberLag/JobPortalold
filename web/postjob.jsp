                                    ...
                                    <div>
                                        <section>
                                            ...
                                            <div class="radio-inline">
                                                <label><input type="radio" name="is_public" value="1">Public</label>
                                            </div>

                                            <div class="radio-inline">
                                                <label><input type="radio" name="is_public" value="0">Private</label>
                                            </div>
                                        </section>
                                        ...
                                        <section>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="number" class="form-control" name="experience_needed" placeholder="Needed working experience(in years)">
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <input type="number" value="0" class="form-control" name="ques_amount" min="0" placeholder="Question Amount" required="">
                                                </div>
                                            </div>
