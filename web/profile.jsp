        ...
        <%
            ...
            //out.print(session.getAttribute("id"));
                ...
                if (request.getParameter("customer_id") != null) {
                    ...
                    session.setAttribute("id", session.getAttribute("customer_id"));
                }
...
//out.print(query3);
                String url = "profile.jsp?customer_id=" + rs.getInt("customer_id");
                String img_dir = "img/" + rs.getInt("customer_id") + ".jpg";
