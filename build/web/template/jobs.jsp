                                ...
                                <div class="content">
                                    ...
                                    <div class="clearfix">
                                        <form method="post">
                                            ...
                                            <input class="btn btn-default pull-left" type="submit" value="Apply For This Job">
                                            <%} else if (jobs.applied[i] == 0 && jobs.ques_flag[i] == 1) {%>
                                            <a href="answer-paper.jsp" class="btn btn-default pull-left">Apply For This Job</a>
                                            <%} else {%>
