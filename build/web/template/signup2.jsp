        ...
        <%
            ...
            try {
                ...
                if (request.getParameter("is_image_selected") == null && !request.getParameter("password1").toString().equals(request.getParameter("password2").toString())) {
                    response.sendRedirect("http://localhost:8084/JobPortal/template/signup1.jsp");
                }
                ...
                String query1 = "insert into customer values(" + customer_id + ",'" + fullname + "','" + surname + "','" + address_house + "','" + address_street + "','"
                        + address_city + "','" + address_state + "','" + address_country + "','" + address_zipcode + "','" + phone_mobile + "','" + phone_work + "','" + phone_fax + "','" + dob_day
                        + "','" + dob_month + "','" + dob_year + "','" + gender + "','" + nationality + "','" + emails + "','" + password1 + "','" + customer_location + "','" + customer_department + "','" + customer_degree + "','"
                        + customer_website + "','" + customer_university + "','" + customer_university_location + "','" + customer_details + "')";
